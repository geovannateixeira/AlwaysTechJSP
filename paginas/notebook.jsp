        ...
        <aside>
            ...
            <div class="box_filter hide_filter mb_box_filter">
                <div class="box_hide_filter">
                    <p class="subTitle_filter text_hide_filter">Marca</p>
                    <img src="https://i.ibb.co/ggqgZ1T/arrow-down.png" alt="arrow-down">
                </div>
                <div class="filter_content" id="marca_content" style="display: none;">
                    <label>
        ...
        <main>
            <section class="vend">
                <h1 class="title"> Mais Vendidos </h1>
                  ...
                  <% 
                    ...
                    try {
                        sql = "SELECT cod_prod, nome_prod, preco, imagem FROM notebook ORDER BY qtd_vendido desc";
                        rs = stm.executeQuery(sql);
                        while(rs.next()) {
                            if(i >= 3) {
                                break;
                            }
                            out.print("<div class='note'>");
                                out.print("<a href='produto.jsp?id=" + rs.getInt(1) + "&categoria=note'>");
            ...
            <section class="vend">
                <h1 class="title"> Populares </h1>
                  ...
                  <% 
                    try {
                        sql = "SELECT cod_prod, nome_prod, preco, imagem FROM notebook";
                        rs = stm.executeQuery(sql);
                        while(rs.next()) {
                            out.print("<div class='note'>");
                                out.print("<a href='produto.jsp?id=" + rs.getInt(1) + "&categoria=note'>");
